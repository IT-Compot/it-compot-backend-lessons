...
# Зачем нам **модели** и **миграции** в Django?
...
9. **Настраиваем сохранение медиафайлов**
...
---
# Если чувствуете, что не успеваете, то можете оставить админку на след.урок
...
11. **Регистрируем модель в админке**
...
13. **Создаём посты через админку**
